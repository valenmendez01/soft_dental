  ...
  return (
    <div className="container ml-3 mt-4">
      <div className="d-flex align-items-center justify-between">
        <h1 className="fs-4">Historial y evolución</h1>
      </div>
      <div className="mt-5">
        <div className="flex items-center justify-center bg-white px-6 md:px-40">
          <div className="pl-1">
            <ol className="relative border-l-2 border-dashed border-gray-200 dark:border-gray-700">                  
