...
const CalendarViewWithUpcomingEvent = () => {
  return (
    <div>
      <h2 className="text-base font-semibold leading-6 text-gray-900">Próximos turnos</h2>
...
export default CalendarViewWithUpcomingEvent